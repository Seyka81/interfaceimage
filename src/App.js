...
function App() {
  ...
  const pseudo = [
    { pseudoNom: 'Toto', present: true },
    { pseudoNom: 'Tata', present: true },
    { pseudoNom: 'Tutu', present: false },
    { pseudoNom: 'Titi', present: true },
    { pseudoNom: 'Tete', present: true }
  ];
  ...
  const clientTraitement = (e) => {
    ...
    refaireImages(clientAtraiter).then((resp) => setList(resp));
  };
        ...
        <Box sx={{ display: 'flex' }}>
          ...
          >
            <Toolbar>
              ...
              >
                <img
                  src="http://www.eanqa.fr/wp-content/uploads/2022/02/logo-degrade-eanqa-horizontal.png"
                  alt="eanqa"
                  width="200"
                  height="60"
                ></img>
              ...
              >
                <TableHead>
                  <TableRow>
                    ...
                    {clientEncours !== 'Clients' ? (
                      <TableCell align="right">Url Image</TableCell>
                    ) : (
                      <TableCell align="right">Nombre Images</TableCell>
                    )}
                    {clientEncours !== 'Clients' && (
      ...
      <TableRow key={this.props.id}>
        ...
        {this.props.clientenCours !== 'Clients' ? (
          <TableCell
            id={this.props.id}
            align="right"
            onClick={this.props.fonction}
          >
            {this.props.imgUrl}
          </TableCell>
        ) : (
          <TableCell id={this.props.id} align="right">
            {this.props.imgUrl}
          </TableCell>
        )}
        {this.props.clientenCours !== 'Clients' && (
